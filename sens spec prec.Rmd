---
title: "Sensitivity, specificity, and precision"
author: "Rob Walker"
...
out = data.frame(FICO=possible_k,specificity,sensitivity,precision)
out <- melt(out, id.vars = "FICO", variable.name = "Metric", value.name = "Data")

ggplot(out, aes(x = FICO, y = Data, color = Metric)) + geom_line(size=2) +
  ylab("") + xlab("FICO") + scale_color_manual(name="", labels=c("Specificity","Sensitivity","Precision"), values=c("red","green","blue"))
